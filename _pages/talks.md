...
<!-- 
**2023** -->
<!-- - **Hi Guys or Hi Folks? Benchmarking Gender-Neutral Translation with the GeNTE Corpus** — *Talk* — FAIR Workshop, Fondazione Bruno Kessler, Povo — December 2023 -->
- **Queering Law and Technology: Discriminazione e Intelligenza Artificiale** — *Panel* — [Workshop organized by the Faculty of Law, University of Trento](https://webmagazine.unitn.it/fileswebmagazine/download/118008/locandinawebinardd26102023_0.pdf) — October 2023
- **Situating Research and Technology** — *Panel and Talk* — Picture a Scientist, University of Pisa — February 2023
<!-- 
**2022** -->
- **Good but not always Fair: Gender Bias in Automatic Translation** — *Talk* — [Language in the Human-Machine Era (LITHME) COST Action](https://lithme.eu/), Online — February 2023
- **Gender Bias in Machine Translation: Taking stock of where we are** — *Talk* — [Gender Equality and Artificial Intelligence Workshop, L'Aquila University](https://phdict.disim.univaq.it/events/workshop-gender-equality-and-artificial-intelligence-workshop/) — November 2022
- **Ethical Aspects in NLP: A Teaching and Learning Experience** — *Talk* — [MilaNLP Lab: Coding Aperitivo](https://milanlproc.github.io/coding_aperitivo/), Bocconi University — September 2022
- **Gender as a Variable in Natural Language Processing** — *Panel* — [Queer in AI Workshop](https://www.queerinai.com/naacl-2022) at NAACL, Seattle — July 2022
<!-- 
**2021** -->
- **Gender in Danger: Bias and Automatic Translation** — *Talk* — [TranslatingEurope Workshop (TEW): Translation and the use of inclusive language](https://dflti.ionio.gr/translating-europe/2021/en/presentations/), University of Thessaloniki, Online — December 2021
- **Understanding Gender Bias in Translation Technologies** — *Talk* — European Night of Researchers: Mind the Gap, University of Parma, Online — September 2021
- **Gender Bias and Automatic Translation** — *Talk* — Interdisciplinary Linguistics Colloquium, University of Augsburg, Online — June 2021
- **Gender Bias and Automatic Translation** — *Talk* — [GroNLP group, University of Groningen](https://www.rug.nl/research/clcg/research/cl/?lang=en), Online — May 2021
<!-- 
**2020** -->
- **Gender in Danger? Evaluating Speech Translation Technologies on the MuST-SHE Corpus** — *Talk* — Conversazioni Linguistiche, University of Trento — June 2020
